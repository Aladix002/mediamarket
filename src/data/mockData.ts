...
export const mockMedia = [
  { id: 'm1', name: 'iDNES.cz', type: 'online', logo: '📰' },
  { id: 'm2', name: 'Rádio Impuls', type: 'rádio', logo: '📻' },
  { id: 'm3', name: 'JCDecaux', type: 'OOH', logo: '🏢' },
  { id: 'm4', name: 'Economia', type: 'print', logo: '📄' },
  { id: 'm5', name: 'Stream.cz', type: 'online', logo: '▶️' },
  { id: 'm6', name: 'Kiss Rádio', type: 'rádio', logo: '🎵' },
  { id: 'm7', name: 'Aktuálně.cz Newsletter', type: 'newsletter', logo: '📧' },
  { id: 'm8', name: 'BigBoard', type: 'OOH', logo: '🖼️' },
];

export type MediaType = 'online' | 'rádio' | 'OOH' | 'print' | 'newsletter';
...
export const mockOffers: Offer[] = [
  ...
  {
    id: '7',
    title: 'Exkluzivní newsletter sponzoring',
    mediaId: 'm7',
    mediaName: 'Aktuálně.cz Newsletter',
    mediaType: 'newsletter',
    format: 'Banner + nativní článek',
    priceFrom: 22000,
    validFrom: '2026-01-15',
    validTo: '2026-02-15',
    description: '150 000 odběratelů, open rate 42%.',
    whatsIncluded: ['4 rozesílky', 'Header banner', 'Nativní mention'],
    terms: 'Grafika 600x200px, text max 50 slov.',
  ...
  },
  {
    ...
    mediaName: 'Aktuálně.cz Newsletter',
    mediaType: 'newsletter',
    format: 'Exkluzivní rozesílka',
    priceFrom: 45000,
    validFrom: '2026-01-20',
    validTo: '2026-02-20',
    description: 'Celý newsletter věnovaný vaší značce.',
    whatsIncluded: ['1 rozesílka', 'Full branding', 'Dedikovaný content'],
    terms: 'Kompletní obsah dodá klient.',
    deadline: '7 pracovních dnů',
    tags: ['speciál'],
    status: 'published'
  },
  ...
  {
    id: '23',
    title: 'B2B newsletter segment',
    mediaId: 'm7',
    mediaName: 'Aktuálně.cz Newsletter',
    mediaType: 'newsletter',
    format: 'Segment banner',
    priceFrom: 12000,
    validFrom: '2026-01-15',
    validTo: '2026-02-28',
    description: 'Cílení na business segment odběratelů.',
    whatsIncluded: ['2 rozesílky', 'Banner 600x100', 'Měření kliků'],
    terms: 'Grafika + landing page.',
    deadline: '3 pracovní dny',
    tags: ['akce'],
    status: 'published'
  },
  ...
  {
    id: '31',
    title: 'Tech newsletter premium',
    mediaId: 'm7',
    mediaName: 'Aktuálně.cz Newsletter',
    mediaType: 'newsletter',
    format: 'Dedicated tech email',
    priceFrom: 35000,
    validFrom: '2026-02-01',
    validTo: '2026-03-01',
    description: 'Tech segment s 45k odběrateli.',
    whatsIncluded: ['2 rozesílky', 'Hlavní banner', 'CTA button'],
    terms: 'Tech relevantní content.',
    deadline: '5 pracovních dnů',
    tags: ['akce', 'speciál'],
    status: 'published'
  },
